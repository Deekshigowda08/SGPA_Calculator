...
const Centrebox2 = () => {
    ...
    return (
        <>
        <div className='h-screen m-auto block md:hidden md:w-[100%] sm:grid sm:place-content-center'>
        ...
        <div className='fixed top-[12%] md:block sm:hidden left-[10%] bg-stone-300 w-[80%] h-[90%]'>
            ...
            <button onClick={HandleChange2} className='bg-green-500 text-white text-xl font-semibold py-3 px-5 rounded-full fixed bottom-2 left-[47%]'>Submit</button>
        </div>
        </>
    )
}
